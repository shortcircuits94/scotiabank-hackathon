    ...
    <>
      <section className="bottom-details">
        ...
        <div className="bottom-details__container">
          ...
          <div className="bottom-details__bookings">
            <div>
              <p className="bottom-details__title">Strategic Planning</p>
              <p className="bottom-details__info">45 minutes</p>
            </div>
            <div className="bottom-details__container-button">
              <button className="bottom-details__button">Book Now</button>
            </div>
          ...
          <div className="bottom-details__bookings">
            <div>
              <p className="bottom-details__title">Comprehensive Review</p>
              <p className="bottom-details__info">1 hour</p>
            </div>
            <div className="bottom-details__container-button">
              <button className="bottom-details__button">Book Now</button>
            </div>
